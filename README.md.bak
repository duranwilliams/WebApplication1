...
History:
2025.11.8 - Fix reference to old folder name in relative path, took raw file dmp out of ui, try to workaround warning messages without tring to optimize the code yet, implement debug instead of output to console, 
